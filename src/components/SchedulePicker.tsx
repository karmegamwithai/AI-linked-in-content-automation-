      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        {onPublishNow && (
          <button
            ...
            className="px-4 py-2 text-xs font-bold rounded-full bg-gradient-to-r from-pink-500 to-violet-600 hover:from-pink-400 hover:to-violet-500 text-white shadow-md shadow-pink-500/20 active:scale-95 transition-all self-start sm:self-auto min-h-[40px]"
          >
            Publish Live Now
          </button>
        )}
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2.5 bg-white border border-zinc-200 rounded-2xl text-xs font-semibold text-zinc-900 focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500/30 font-mono transition-all shadow-2xs min-h-[44px]"
          />
        </div>
      </div>
