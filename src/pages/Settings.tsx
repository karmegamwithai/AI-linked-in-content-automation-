  ...
  return (
    <div id="page-settings" className="space-y-6 max-w-5xl mx-auto pb-12">
      ...
      <div className="p-6 md:p-8 rounded-3xl bg-zinc-50 border border-zinc-200 space-y-6 shadow-xs">
        <div>
          <h2 className="text-lg font-bold text-zinc-900 tracking-tight">Individual Social Accounts</h2>
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        {isLinkedin ? <Linkedin className="w-4 h-4 text-sky-600" /> : <Instagram className="w-4 h-4 text-pink-600" />}
                        <h4 className="text-sm font-bold text-zinc-900">{account.accountName}</h4>
                      </div>
                ...
                <div className="space-y-1.5 text-xs text-zinc-600 pt-2 border-t border-zinc-100">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-zinc-900">{isLinkedin ? 'Personal Profile (UGC API)' : 'Personal / Creator IG (Graph API)'}</span>
                  </div>
                  <div className="flex justify-between">
      ...
      <div className="p-6 md:p-8 rounded-3xl bg-zinc-50 border border-zinc-200 space-y-5 shadow-xs">
        <h2 className="text-lg font-bold text-zinc-900 tracking-tight">Automation Preferences</h2>

        <div className="space-y-4 text-xs">
          <div className="flex items-center justify-between p-4 rounded-2xl bg-white border border-zinc-200 shadow-2xs">
            <div>
          ...
          <div className="p-4 rounded-2xl bg-white border border-zinc-200 space-y-2 shadow-2xs">
            ...
            <select
              ...
              className="w-full px-4 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-zinc-900 font-semibold focus:outline-none focus:border-pink-500"
            >
